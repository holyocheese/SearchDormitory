...
public class DateUtil {
    ...
    public static final String dtStandard = "yyyy-MM-dd";
    /**
     * 返回系统当前时间(精确到毫秒)</br>
     * @return
    ...
    public static void main(String[] args) {
        DateUtil due = new DateUtil();
        System.out.println(due.daysBetween("2016-07-18", "2016-07-20"));
        logger.info("两个日期间隔天数:", due.daysBetween("2016-07-18", "2016-07-20"));
	}
...
//			System.out.println(e.getMessage());
            logger.error("设置日期出错:", e.getMessage());
	...
	/**
     * 将当前时间进行小时增加运算并返回
     * @param curDate 被计算的日期时间
     * @param hour    要增加的小时数
     * @return        计算后的记过
     * @throws ParseException
     */
    public static Date addHours(Date curDate, int hour) throws ParseException {
        Calendar calendar = Calendar.getInstance();
